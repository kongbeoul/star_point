...
(function(window, $, TweenMax, Swiper, _, App){
      ...
      addEvents: function() {
        ...
        function handlePointerMove(e) {
          ...
          var pos = utils.call(_this, e),
              count = _this.$starChild.filter("[class*="+ _this.childActiveClass +"]").length;
        ...
        $(document).off("touchend mouseup").on("touchend mouseup", handlePointerUp);
  ...
  App.create = function(namespace, value) {
    this[namespace] = _.isFunction(value) ? _.create(Object.prototype, value()) : value;
  }
          ...
          mapToSwipe({
            ...
            on: {
              init: function(){
                ...
                for(var i = 1, len = self.slides.length / 3; i <= len; i++) {
                  (function(j){
